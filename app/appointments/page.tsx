    ...
    <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
      ...
      <main className="flex-grow container mx-auto px-6 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Appointment Scheduler</h1>
            <p className="text-gray-600">
              Manage your medical appointments with ease. Book, reschedule, and track your healthcare visits.
            </p>
          </div>
